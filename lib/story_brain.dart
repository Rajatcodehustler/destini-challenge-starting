...
class Storybrain {
  ...
  List<Story> _storyData = [
    ...
    Story(storyTitle: 'He nods slowly, unphased by the question.',
  ...
  String getstory() {
    return _storyData[storyNumbr].storyTitle;

  }

  String getchoice1() {
    return _storyData[storyNumbr].choice1;
  }

  String getchoice2() {
    return _storyData[storyNumbr].choice2;
  }

  void nextStory(int choiceNumber) {
    if ((choiceNumber == 1) && (storytitle1 == _storyData[0].storyTitle)) {
      storyNumbr = 2;
    }
      if ((choiceNumber == 1) && (storytitle1 == _storyData[2].storyTitle)) {
        storyNumbr = 5;
      }
       if ((choiceNumber == 2) && (storytitle1 == _storyData[2].storyTitle)) {
        storyNumbr = 4;
      }

     if ((choiceNumber == 2) && (storytitle1 == _storyData[0].storyTitle)) {
        storyNumbr = 1;
      }
    if ((choiceNumber == 1) && (storytitle1 == _storyData[1].storyTitle)) {
        storyNumbr = 2;
      }
     if ((choiceNumber == 2) && (storytitle1 == _storyData[1].storyTitle)) {
        storyNumbr = 3;
      }
     if((choiceNumber==1)&&(storyNumbr==3)&&(storyNumbr==4)&&(storyNumbr==5)){
       reset();
     }
    }
  ...
  bool buttonShouldBeVisible() {
    if((storyNumbr==0)||(storyNumbr==1)||(storyNumbr==2))
    {
      return true;
    }
    else
